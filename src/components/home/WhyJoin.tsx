...
export function WhyJoin() {
  return (
    <section id="why-join" className="py-24 bg-surface border-b border-border">
          ...
          {benefits.map((b, i) => {
            ...
            return (
              <motion.div
                ...
                className="p-6 rounded-xl bg-background border border-border flex flex-col gap-4"
              >
                <div className="w-10 h-10 rounded-lg bg-surface border border-border flex items-center justify-center text-accent shadow-sm">
