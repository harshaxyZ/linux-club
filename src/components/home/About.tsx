...
export function About() {
  return (
    <section id="about" className="py-24 relative overflow-hidden border-t border-white/[0.08] bg-black">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        
        {/* Section Header */}
        <div className="max-w-3xl mx-auto text-center mb-16">
          <div className="inline-flex items-center gap-2 text-xs font-mono text-red-500 uppercase tracking-wider mb-3">
            <Terminal className="w-3.5 h-3.5" />
            <span>// Engineering Philosophy</span>
          </div>
          <h2 className="font-heading font-extrabold text-white text-3xl sm:text-5xl tracking-tight leading-tight">
            We build real software, solve hard problems, and ship.
          </h2>
          <p className="text-base text-[#A3A3A3] mt-4 leading-relaxed">
        ...
        {/* Bento Grid in Minimal Black/White/Grey/Red */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            ...
            <div className="mt-8 pt-4 border-t border-white/[0.06] flex items-center gap-2 text-xs font-mono text-red-400">
          ...
          >
            ...
            <div className="mt-8 pt-4 border-t border-white/[0.06] flex items-center gap-2 text-xs font-mono text-white">
              <span className="w-1.5 h-1.5 rounded-full bg-red-500" />
