      ...
      <header className="border-b border-border sticky top-0 z-40 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="hidden md:block font-heading font-bold text-base">OSSC <span className="text-ink-muted font-mono text-xs">DBIT</span> <span className="text-accent font-mono text-xs uppercase bg-accent/10 border border-accent/20 px-2 py-0.5 rounded ml-1">Admin</span></span>
          </div>
            ...
            {inviteDone ? (
              ...
              <form onSubmit={sendInvite} className="space-y-4">
                ...
                <div className="flex justify-end gap-3 pt-4 border-t border-border">
                  ...
                  <button type="submit" disabled={inviteLoading} className="bg-accent !text-accent-contrast font-mono font-bold text-xs px-5 py-2.5 rounded-xl disabled:opacity-50 cursor-pointer">
